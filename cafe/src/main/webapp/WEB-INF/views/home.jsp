...
<head>
  ...
  <style type="text/css">
  .bg-gradient-primary { background-image: linear-gradient(180deg,#e74a3b 10%,#e74a3b 100%); }
  </style>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <jsp:include page="/WEB-INF/views/modules/usersidebar.jsp" />
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">카페</h1>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="/cafe/resources/img/undraw_posting_photo.svg" alt="">
                  </div>
