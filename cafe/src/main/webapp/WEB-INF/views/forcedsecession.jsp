    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">강제탈퇴 멤버 관리</h1>
                    
	      <p class="mb-4">운영자가 강제 탈퇴시킨 멤버로 3개월간만 보관되며, 멤버 스스로 탈퇴한 기록은 남지 않습니다.<br>카페 멤버를 가입 불가처리하면 자동으로 탈퇴 처리됩니다.<br>멤버에 대한 강제탈퇴는 전체 멤버 관리에서 하실 수 있습니다.</p>
