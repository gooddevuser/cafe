    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">가입 불가 관리</h1>
                    
	      <p class="mb-4">운영자가 가입 불가 처리한 멤버를 보여주며, 우리 카페에 가입하지 않은 사람을 가입하지 못하도록 할 수 있습니다.</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">가입 불가 멤버 수 1</h6>
            </div>           
            <div class="card-body">
